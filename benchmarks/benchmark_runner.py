...
def _build_run_result(run_id, task, variant, state, recorder, hidden, termination_reason, initial_commit):
    ...
    return RunResult(
        ...
        planning_validation_failures=state.planning_validation_failures,
        planning_repair_attempts=state.planning_repair_attempts,
        planning_repair_success=state.planning_repair_success,
